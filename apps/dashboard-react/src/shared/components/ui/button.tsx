...
const buttonVariants = cva(
  'inline-flex min-h-8 items-center justify-center gap-1.5 whitespace-nowrap rounded-[var(--radius-md)] border px-3 text-[length:var(--text-body-size)] font-semibold leading-[var(--text-body-line)] transition-[background,border-color,color] duration-[var(--motion-fast)] ease-[var(--ease-standard)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--brand-600)] disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        ghost: 'border-transparent bg-transparent text-[var(--ink-secondary)] hover:bg-[var(--surface-2)] hover:text-[var(--ink-primary)]',
      ...
      size: {
        ...
        md: 'min-h-8 px-3',
        lg: 'min-h-9 px-3 text-[length:var(--text-h3-size)] leading-[var(--text-h3-line)]',
      },
    },
    defaultVariants: {
      variant: 'default',
