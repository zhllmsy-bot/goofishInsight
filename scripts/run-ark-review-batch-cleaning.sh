...
ARK_REVIEW_MAX_TOKENS="${ARK_REVIEW_MAX_TOKENS:-${ARK_AI_MAX_TOKENS:-${AI_MAX_TOKENS:-5000}}}"
...
export AI_MAX_TOKENS="$ARK_REVIEW_MAX_TOKENS"
...
export ARK_AI_MAX_TOKENS="$ARK_REVIEW_MAX_TOKENS"
export ARK_AI_ENABLE_THINKING="false"
export PYTHONPATH="apps/collector/src"

exec ./.venv/bin/python -m goofish_insight.cli review-items-llm "$@"
